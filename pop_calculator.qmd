...
ui <- page_sidebar(
  ...
  sidebar = sidebar(
    ...
    downloadButton("info", "Telechargez le fichier à remplir", icon = icon("download")),
  ...
  card(
    card_header(
      ...
      downloadButton("adjusted", "Telechargez les populations ajustées", icon = icon("download"))
    ),
    card_body(
