...
1. Télécharger le fichier d'information à remplir <https://who-ist-ca.github.io/triangulation/data/infos.xlsx>. **NB: Les couvertures de l'ECV doivent être remplies en proportion et non en pourcentage**
...
4. Si on a les données de l'ECV rempli dans le fichier, il faut cliquer sur le boutton qui doit laisser apparaitre une couleur verte
  ...
  tab <- reactive({
    ...
    tryCatch({
      ...
      results <-  data$merged |>
        ...
        mutate(
          naissances_adj = abs(survivants_adj /(1- (55 / 1000) ))
        ) |>
        mutate(
